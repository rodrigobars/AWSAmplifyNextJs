...
const MainContainer: React.FC = () => {
    ...
    //bg-gradient-to-br from-blue-900 to-purple-300
    return (
        <>  
            <main className='flex justify-center items-center shrink-0 w-lg p-8 min-h-lvh'>
                <div className='bg-black bg-opacity-50 rounded-lg p-10 border'>
